...
- [ ] 4.1 JUP-013 apply migrations 001 through 003 to an isolated fresh
  CockroachDB database and verify normalized record persistence and retrieval
- [ ] 4.2 JUP-013 upgrade an isolated database containing migrations 001/002
...
- [ ] 4.3 JUP-013 verify typed fields, tags, optional consumption, unknown
...
- [ ] 4.4 JUP-013 repeat ingestion with the same tenant, subscription, query
...
- [ ] 4.6 JUP-013 fix the existing-table migration 003 DDL visibility defect
...
- [ ] 4.7 JUP-013 verify fresh creation and the six-row 001/002 upgrade on
...
- [ ] 4.8 JUP-013 verify version-insert failure and subsequent retry, committed
...
- [ ] 4.9 JUP-013 verify numeric legacy tags, complete mixed tag sources and
