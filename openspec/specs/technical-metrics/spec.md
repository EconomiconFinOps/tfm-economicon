# technical-metrics Specification

## Purpose

Los servicios `backend` y `processor` exponen métricas técnicas (latencia, errores, volumen de
ingestas y consultas) en formato Prometheus, scrapeadas por un Prometheus local y visualizadas en
un dashboard de Grafana provisionado como código, según la decisión de arquitectura registrada en
[ADR-0005](../../../docs/adr/ADR-0005-prometheus-grafana-metrics.md).
