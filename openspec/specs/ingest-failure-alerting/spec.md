# ingest-failure-alerting Specification

## Purpose

El `processor` alerta cuando los fallos de ingesta superan un umbral en una ventana de tiempo,
usando Grafana Unified Alerting sobre las métricas técnicas ya expuestas por
[technical-metrics](../technical-metrics/spec.md) (ADR-0005). Sin receptor externo en esta
iteración: el estado de la alerta es visible en el dashboard de Grafana, decisión explícita del
equipo para no reabrir la política de solo-lectura de Discord fijada en JUP-081.
