# frontend-quality-baseline Specification

## Purpose
Define the JUP-087 frontend quality baseline: zero-error lint with explicit prop
contracts, a real test runner in the workspace and CI, and isolated positive
and failure coverage for critical MVP journeys. These gates do not certify
the completeness of backend capabilities or replace integrated runtime tests.
