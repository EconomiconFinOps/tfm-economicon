...
Los servicios `backend` y `processor` emiten logs en JSON estructurado con correlación por
`request_id`, para poder depurar errores y diagnosticar el estado de la plataforma sin grep manual
de texto libre. El frontend queda fuera de alcance.
