# document-ingestion-handoff Specification

## Purpose

Adapt backend ingestion job envelopes to the processor graph while preserving
document content, envelope identity, safe failure handling and request
correlation. This contract covers the handoff fixed by JUP-020; it does not
define production embedding providers or full corpus reprocessing.
