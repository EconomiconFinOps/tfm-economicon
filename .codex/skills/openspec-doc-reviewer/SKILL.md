...
description: Review documentation drift after an OpenSpec change is archived. Use when a change has just been archived, when the user asks for a post-archive documentation review, or when Codex needs to update docs/architecture.md, app READMEs, docs/hu-release-notes.md, manuals, and ADR recommendations based on completed implementation.
---
